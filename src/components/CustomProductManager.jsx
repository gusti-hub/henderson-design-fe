...
const SERVICE_OPTIONS = [
  ...
  'WINDOW COVERING INSTALLATION SERVICE',
...
const SERVICE_DESCRIPTIONS = {
  ...
  'CLOSET INSTALLATION SERVICE': 'Labor and coordination associated with the installation of approved closet systems, cabinetry, and storage components.',
  ...
  'WINDOW COVERING INSTALLATION SERVICE': 'Labor and coordination associated with the installation of approved window coverings including drapery, shades, and blinds.',
...
const defaultSelectedOptions = () => ({
  ...
  revisedOrderDate: '', expectedShipDate: '', expectedArrivalDate: '', dateReceived: '', dateInspected: '',
...
const ALLOWED_WHEN_LOCKED = new Set([
  ...
  'selectedOptions.orderDate', 'selectedOptions.revisedOrderDate', 'selectedOptions.expectedShipDate',
...
const ProductCard = ({
  ...
  const buildProductPayload = (src) => ({
    ...
    selectedOptions: {
      ...
      revisedOrderDate:      src.selectedOptions?.revisedOrderDate      || '',
