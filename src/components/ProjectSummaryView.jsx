...
export const T = {
  ...
  jp: {
    ...
    s3Accents:    'Proposal 2 – アクセント費用見込み',
    s3Closet:     'クローゼットシステム費用見込み',
    s3Window:     'ウィンドウトリートメント費用見込み',
    s3Fdi:          'FDI費用見込み\n（輸送・搬入・設置費用）',
    s3Av:           'AV費用',
    s3Additional:   '追加サービス・特別コーディネーション',
    s3Total:        '推定残費用合計',

    s4Title:      '最終プロジェクト費用予測',
    s4Approved:   'ご提案費用（現在まで）',
    s4Remaining:  '推定残費用',
    s4Final:      '推定最終プロジェクト費用',

    outlookTitle:    '現在の投資状況の見通し',
    outlookSub:      'プロジェクトの概要',
    outlookOrig:     '当初ご選択の投資額',
    outlookApproved: 'ご提案費用（現在まで）',
    outlookRemaining:'推定残費用',
    outlookFinal:    '推定最終プロジェクト費用',
    depositHeld:     'お預かりデポジット',
    depositNote:     '最終精算時に充当されます。',
    projManaged:     'プロジェクトはすべての段階で透明性を保ち、丁寧に管理されています。',
    ...
    appreciate:   'ご信頼いただき、誠にありがとうございます。',
    continueBtn:  '質問票へ進む',
