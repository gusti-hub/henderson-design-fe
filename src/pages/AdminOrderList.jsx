...
const ProposalSelectModal = ({ loadingVersions, proposalVersionsData, selectedVersionRefs, setSelectedVersionRefs, onClose, onConfirm }) => (
  ...
  if (clientOrdersView && !editingOrder) {
    ...
    return (
      <div className="space-y-5">
        ...
        {/* Proposal version selection modal — also needed in client orders view */}
        {proposalSelectModal && <ProposalSelectModal
          loadingVersions={loadingVersions}
          proposalVersionsData={proposalVersionsData}
          selectedVersionRefs={selectedVersionRefs}
          setSelectedVersionRefs={setSelectedVersionRefs}
          onClose={() => setProposalSelectModal(false)}
          onConfirm={handleConfirmBulkProposals}
        />}
      </div>
    );
  }
