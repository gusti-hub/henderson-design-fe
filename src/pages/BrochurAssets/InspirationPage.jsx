...
const InspirationPage = () => {
  ...
  const galleryImages = [
    ...
    { id: 20, src: "/images/collections/5.jpg" },
  ];
  ...
  return (
    <div className="pt-32 pb-24 px-6 bg-gradient-to-b from-gray-50 to-white">
      ...
      {selectedImage && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-md transition-opacity duration-300 will-change-transform"
        >
          <button
            onClick={closeImage}
          ...
          <img
            ...
            className="max-w-[90%] max-h-[80vh] object-contain rounded-lg shadow-2xl select-none will-change-transform"
          />
          <button
